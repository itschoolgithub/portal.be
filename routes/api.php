...
Route::get("/admin/articles/{article}", [AdminArticleController::class, "show"])->middleware('auth:sanctum');
Route::put("/admin/articles/{article}", [AdminArticleController::class, "update"])->middleware('auth:sanctum');
